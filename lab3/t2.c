...
pthread_cond_t		done_world;     //ADDED signaling variables for world to again
int 			done = 0;      	// testing variable
int			done2 = 0;

int main (int argc, char *argv[]){
    //ADDED again thread necessary variables, initialization
...
void world() {
    ...
    done2 = 1;//ADDED signaling to again thread
